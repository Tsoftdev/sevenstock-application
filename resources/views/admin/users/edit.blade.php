        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form-horizontal mt-4 needs-validation" method="POST" action="{{ route('admin.user.edit', ['id' => $user->id]) }}" novalidate>
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="justify-content-start d-flex">
                                    ...
                                    <a href="{{ url('admin/users') }}" class="btn btn-danger btn-sm"><i class="mdi mdi-backspace-outline"></i> back</a>
                                </div>
                            </div>
                        </div>
                    </form>
