    ...
    {{-- <div class="row">
        <div class="col-12">
            ...
            <div class="email-leftbar card">
                ...
                <div class="mail-list mt-3">
                    <a href="#"><span class="mdi mdi-arrow-right-drop-circle text-info float-end mt-1  ms-2"></span>Theme
                        Support</a>
                    <a href="#"><span class="mdi mdi-arrow-right-drop-circle text-warning float-end mt-1 ms-2"></span>Freelance</a>
                    <a href="#"><span class="mdi mdi-arrow-right-drop-circle text-primary float-end mt-1 ms-2"></span>Social</a>
                    <a href="#"><span class="mdi mdi-arrow-right-drop-circle text-danger float-end mt-1 ms-2"></span>Friends</a>
                    <a href="#"><span class="mdi mdi-arrow-right-drop-circle text-success float-end mt-1  ms-2"></span>Family</a>
                </div>
                    ...
                    <ul class="message-list">
                        <li class="unread">
                            ...
                            <div class="col-mail col-mail-2">
                                <a href="#" class="subject">Hello &nbsp;–&nbsp; <span class="teaser">Trip home from Colombo has been arranged, then
                        ...
                        <li class="unread">
                            ...
                            <div class="col-mail col-mail-2">
                                <a href="#" class="subject"><span class="bg-success badge me-2">Family</span>Last pic over my
                                    village &nbsp;–&nbsp;
                        ...
                        <li>
                            ...
                            <div class="col-mail col-mail-2">
                                <a href="#" class="subject">Train/Bus &nbsp;–&nbsp; <span class="teaser">Yes ok, great! I'm not stuck in Stockholm
