            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <form class="form-horizontal mt-4 needs-validation" method="POST" action="{{ url('admin/add_roles') }}" novalidate>
                                @csrf
                                <div class="row mb-3">
                                        ...
                                        <ul style="display: inline-block;list-style-type: none;padding:0;margin:0;">
                                            ...
                                            <li class="checkbox" style="display: inline-block; min-width: 170px;">
                                                <label class="form-check-label">
                                                    <input type="checkbox" class="permission_check form-check-input" name="permission[]" value="{{ $row->id }}"> 
                                                        {{ $row->display_name }}
                                                </label>
                                            </li>
                                            @endforeach
