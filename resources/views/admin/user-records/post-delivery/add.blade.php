        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form-horizontal mt-4 needs-validation" method="POST" action="{{ url('admin/user-record/add_post_delivery') }}" novalidate>
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="" class="form-control pastAddress" id="upostaddress" name="upostaddress" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mt-4 pt-1">
                                    <input class="btn btn-info w-100 fw-bold copyAddress" data-address="" type="button" value="기존 주소 복사">
                                </div>
                            </div>
                        </div>
