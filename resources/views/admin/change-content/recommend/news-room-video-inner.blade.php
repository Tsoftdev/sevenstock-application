    ...
    <div class="col-md-6">
      <div class="card">
        <div class="card-body">
          ...
          <div class="row mb-3">
            <div class="col-md-6">
              <h4 class="card-title">Video Inner Recommend</h4>
            </div>
            ...
            <div class="col-md-12">
              <table id="dt-news-random" class="table dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                ...
                <tbody>
                  ...
                  <tr>
                    <td width="150"><img src="{{$rand->video->images[0]}}" class="img-fluid" alt=""></td>
                    <td>
                      <div class="row">
                        <div class="col-md-8">
                        ...
                        <div class="col-md-4 text-end">
                          <form method="POST" action="{{ url('admin/change-content/recommend/del-video-inner-recommend') . '/' . $rand->id }}">
                            @csrf
...
<script>
  ...
  $(function() {
    ...
    $('body').on('click', '.add-random', function() {
      $('.news-list-form').attr('action', '<?php echo url('admin/change-content/recommend/add-video-inner-recommend'); ?>');
    });
